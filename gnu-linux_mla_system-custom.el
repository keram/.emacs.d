 ...
 '(package-selected-packages
   (quote
    (slime parsebib dash company zoom-window yasnippet-snippets xterm-color
           ...
           gitconfig-mode gitattributes-mode geiser fill-column-indicator
           exec-path-from-shell ess elixir-mode editorconfig dumb-jump
           clojure-mode-extra-font-locking browse-kill-ring apib-mode ag))))
(custom-set-faces
